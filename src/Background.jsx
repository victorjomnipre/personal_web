  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
        ...
        <div className={`p-8 rounded-2xl shadow-sm border transition-colors duration-300 ${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-100'}`}>
            <h3 className={`text-xl font-bold mb-6 border-b pb-2 transition-colors duration-300 ${darkMode ? 'text-white border-gray-600' : 'text-gray-900 border-gray-200'}`}><i className="fas fa-graduation-cap mr-2 text-blue-500"></i> Education</h3>
        ...
        {/* Skills */}
        <div className={`p-8 rounded-2xl shadow-sm border transition-colors duration-300 ${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-100'}`}>
            <h3 className={`text-xl font-bold mb-6 border-b pb-2 transition-colors duration-300 ${darkMode ? 'text-white border-gray-600' : 'text-gray-900 border-gray-200'}`}><i className="fas fa-code mr-2 text-blue-500"></i> Tech Stack</h3>
            ...
            <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2">
                    {['C', 'Java', 'Arduino', 'PHP', 'JavaScript', 'React JS'].map(skill => (
